...
const ZH_CN = Object.freeze({
  ...
  "How to use the version 1.0.4 spectroscopy workspace.": "如何使用 1.0.4 版光谱工作区。",
  ...
  "Save the complete .sflproj archive, export an AI-ready Markdown summary, or create OriginPro output on Windows. OriginPro 8.6–2020 uses experimental LabTalk sheets-only export; OriginPro 2021+ uses the Python adapter.": "保存完整的 .sflproj 归档，导出适合 AI 使用的 Markdown 摘要，或在 Windows 上创建 OriginPro 输出。OriginPro 8.6–2020 使用实验性的 LabTalk 仅工作表导出；OriginPro 2021+ 使用 Python 适配器。",
  ...
  "OriginPro 8.6 or later is required. Versions before 2021 use the experimental LabTalk sheets-only adapter.": "需要 OriginPro 8.6 或更高版本。2021 之前的版本使用实验性的 LabTalk 仅工作表适配器。",
